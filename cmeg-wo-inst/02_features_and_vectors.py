...
# COMMAND ----------
# MAGIC %pip install -q --no-deps databricks-vectorsearch databricks-feature-engineering databricks-sdk "protobuf>=5.29.4,<6"
...
chapter_complete(
    ...
    next_label="03_train_and_register",
    next_url=f"{workspace_url}/#workspace{REPO_ROOT}/03_train_and_register",
)
